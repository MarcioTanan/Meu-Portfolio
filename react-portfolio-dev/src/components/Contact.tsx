...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 13 99142-3249",
      link: "https://wa.me/5513991423249?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "marciottanan@gmail.com",
      link: "mailto:marciottanan@gmail.com.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Santos",
      description: "Jardim Castelo",
      link: "https://goo.gl/maps/k22t953973cxEVKJ8",
